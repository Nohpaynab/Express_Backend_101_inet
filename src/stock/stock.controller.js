...
export const getStock = async (req, res) => {
    try{
        const data = await new StockService().getAll();
        console.log(data);
...
export const addStock = async (req, res) => {
    ...
    try{
        const data = await new StockService().insert(req.body);
...
export const updateStock = async (req, res) => {
    ...
    try{
        const data = await new StockService().update(StockId, payload);
        console.log('data : ', data);
...
export const deleteStock = async (req, res) => {
    ...
    try{
        const data = await new StockService().delete(StockId);
        console.log('data : ', data);
        if (data.affectedRows){
